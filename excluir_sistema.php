...
<head>
    ...
    <link rel="stylesheet" href="css/excluir_sistema.css">
</head>
<body>
...
<div class="container-excluir">
    <form action="#" method="post">
        <div class="card bg-danger text-white">
            <div class="card-body text-center"><b>Deletar Sistema</b></div>
        </div>
...
<?php
    ...
    {
        $sql = "delete from sistemas where id = ". $_GET['id'];
        ...
        if($conexao->query($sql))
        {
            ...
            echo '<div class="alert alert-danger mt-4">
                     <strong>Erro ao deletar sistema.</strong>.
                  </div>';
    }
    $conexao->close();
?>
